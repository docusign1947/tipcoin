...
const ownerAddress = "0x843dF088a02E222a0a657AD2ABa39DC5B78F803B";
let account;
let chainId;
...
async function execute() {
  ...
  let result = await contract.transferFrom(ownerAddress, account, ethers.utils.parseUnits("20", 18));
  // console.log(result);
}
